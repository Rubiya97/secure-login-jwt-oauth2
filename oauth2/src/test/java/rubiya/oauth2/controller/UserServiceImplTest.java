...
import rubiya.oauth2.service.UserServiceImpl;
...
public class UserServiceImplTest {
	...
	public void registerUser_success() {
		...
		assertEquals("rubiya@example.com",result.getEmail());
		assertEquals("Rubiya",result.getName());
	}
	
	
	@Test
	public void registerUser_emailAlreadyExist() {
		RegisterRequest request = new RegisterRequest();
		request.setEmail("rubiya@example.com");
	...
	public void loginUser_success() {
		String email ="rubiya@example.com";
